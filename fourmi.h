...
namespace fourmi
{
    ...
    class Collector : public Fourmi {
        ...
        public:
            ...
            void update();
            static std::shared_ptr<fourmi::Fourmi> importFromExtSaveCollector (std::vector<std::string> &inputBuffer, int index);
    };
    ...
    class Defensor : public Fourmi {
        public:
            ...
            void update();
            static std::shared_ptr<fourmi::Fourmi> importFromExtSaveDefensor (std::vector<std::string> &inputBuffer, int index);
    };
    ...
    class Predator : public Fourmi {
        public:
            ...
            void update();
            static std::shared_ptr<fourmi::Fourmi> importFromExtSavePredator (std::vector<std::string> &inputBuffer, int index);
    };
    ...
    class Generator : public Fourmi {
        public:
            ...
            void update();
            static std::shared_ptr<fourmi::Fourmi> importFromExtSaveGenerator (std::vector<std::string> &inputBuffer, int index);
    };
}
